#!/usr/bin/env bash
# Steam Shader Pre-Cache — uninstaller
set -euo pipefail
...
BIN_LINK="$HOME/.local/bin/steam-shader-compiler"
...
hdr "Steam Shader Pre-Cache Uninstaller"
echo ""
...
[[ -f "$TIMER" ]] && echo "  • Systemd timer + service"
echo ""
...
echo -e "\n${BOLD}Done.${RESET} Steam Shader Pre-Cache has been removed."
